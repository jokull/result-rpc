...
> 0.x release and the API surface can still move. Releases are verified from
> packed consumers and published through protected npm OIDC with provenance; see
